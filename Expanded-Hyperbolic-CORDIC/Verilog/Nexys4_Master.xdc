...
create_pblock pblock_Exponencial
add_cells_to_pblock [get_pblocks pblock_Exponencial] [get_cells -quiet [list Exponencial]]
resize_pblock [get_pblocks pblock_Exponencial] -add {SLICE_X68Y125:SLICE_X89Y140}
resize_pblock [get_pblocks pblock_Exponencial] -add {DSP48_X2Y50:DSP48_X2Y55}
resize_pblock [get_pblocks pblock_Exponencial] -add {RAMB18_X2Y50:RAMB18_X3Y55}
resize_pblock [get_pblocks pblock_Exponencial] -add {RAMB36_X2Y25:RAMB36_X3Y27}
create_pblock pblock_cont_address
add_cells_to_pblock [get_pblocks pblock_cont_address] [get_cells -quiet [list cont_address]]
resize_pblock [get_pblocks pblock_cont_address] -add {SLICE_X76Y119:SLICE_X89Y124}
resize_pblock [get_pblocks pblock_cont_address] -add {DSP48_X2Y48:DSP48_X2Y49}
resize_pblock [get_pblocks pblock_cont_address] -add {RAMB18_X3Y48:RAMB18_X3Y49}
resize_pblock [get_pblocks pblock_cont_address] -add {RAMB36_X3Y24:RAMB36_X3Y24}
create_pblock pblock_uart_mod
add_cells_to_pblock [get_pblocks pblock_uart_mod] [get_cells -quiet [list uart_mod]]
resize_pblock [get_pblocks pblock_uart_mod] -add {SLICE_X72Y122:SLICE_X75Y124}
create_pblock pblock_fsm_test_uart
add_cells_to_pblock [get_pblocks pblock_fsm_test_uart] [get_cells -quiet [list fsm_test_uart]]
resize_pblock [get_pblocks pblock_fsm_test_uart] -add {SLICE_X72Y119:SLICE_X75Y120}
create_pblock pblock_genblk1.mux_32_uart
add_cells_to_pblock [get_pblocks pblock_genblk1.mux_32_uart] [get_cells -quiet [list genblk1.mux_32_uart]]
resize_pblock [get_pblocks pblock_genblk1.mux_32_uart] -add {SLICE_X76Y126:SLICE_X77Y127}
create_pblock pblock_con_mux_data
add_cells_to_pblock [get_pblocks pblock_con_mux_data] [get_cells -quiet [list con_mux_data]]
resize_pblock [get_pblocks pblock_con_mux_data] -add {SLICE_X76Y125:SLICE_X77Y126}
